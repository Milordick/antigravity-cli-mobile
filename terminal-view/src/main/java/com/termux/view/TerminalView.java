    ...
    public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
        ...
        return new BaseInputConnection(this, true) {
            ...
            public boolean commitText(CharSequence text, int newCursorPosition) {
                ...
                if (mEmulator != null && text.length() > 5) {
                    // Fast path for pasting or autocompleting text to avoid character-by-character lag
                    super.commitText("", newCursorPosition); // Clear any composing state in IME
                    getEditable().clear();
